...
def string3(str): 
    ...
    '''
    return 3* str[-2:] 
    #referenced classwork on if statements and slicing 
...
def remove_range(alist, min, max): 
    ...
    *** Important: your code must use comprehensions and should not be more than
    ...
    return alist
    #referenced rephactor on comprehension 
...
def word_count_in_set(words): 
    ...
    *** Solution should not be more than 3 lines of code (can be less)
    ...
    #referenced rephactor; a set does not allow duplicates therefore the length of a set of these words would be a count
...
def topping1(dict): 
    ...
    dict["bread"] = "butter"
    return dict
    #referenced classwork on fav_foods
...
def friend_list(friend_dictionary):
    ...
    return result 
    #referenced rephactor slides for not in
    #referenced classwork on fav_foods
    #asked tutoring center for help with error
